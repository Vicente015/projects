  ...
  return (
    ...
    >
      {buttons?.map(({ description, title, icon, url }) => {
        return (
          <a key={title} className='flex gap-4 p-4 rounded-lg hover:bg-blurple-700 hover:bg-opacity-20 transition-colors duration-[.2s] ease-in' href={url} target='_blank' rel='noreferrer'>
